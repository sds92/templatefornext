export const data = {
  ...
  api: {
    ...
    products: 'https://xn--j1ano.com/uploads/staticsites/belplit24.ru.json',
  ...
  productTitle: 'МДВП',
  contacts: {
    phones: ['+7 (495) 120-27-35'],
    emails: ['stroyoptplit@mail.ru'],
    addresses: [
      {
        title: 'Офис',
    ...
    socials: [['Whatsapp', 'https://wa.me/+79151012913?text=Здравствуйте!']],
  },
  workingHoars: {
    title: 'Время работы',
  ...
  head: {
    title: 'Купить теплоизоляцию, звукоизоляцию, ветрозащиту, утеплитель, МДВП Белтермо',
    meta: [
      {
        name: 'keywords',
        content:
          'купить теплоизоляцию, звукоизоляция купить, мдвп плита, мдвп купить, мдвп цена, белплит (белтермо) купить, белплит (белтермо) цена, плиты белплит (белтермо), утеплитель белплит (белтермо), ветрозащитная плита белплит (белтермо), интернет, магазин, цена, москва, мо, московская область, недорого, дешево, с доставкой, белтермо, белтермо купить, белтермо москва и мо',
      },
      {
        name: 'description',
        content:
          'Купить теплоизоляцию, звукоизоляцию, ветрозащиту, утеплитель, МДВП плиты Белтермо недорого позволит наша низкая цена.',
      },
    ],
  },
  content: {
    main: [
      'Экологичная тепло-звукоизоляция дома',
      'от 280 руб.',
      'Плиты Белтермо - это природный материал на 94% состоящий из сосны! Предназначен для создания эффективной и экологически-чистой звуко/теплоизоляции дома, а также его ветрозащиты',
      'images/belplit24.ru/main',
    ],
    catalog: [
      ['Размеры и цены', 'МДВП БЕЛТЕРМО'],
      'У нас представлены плиты всех размеров, с толщиной МДВП плиты от 20 до 200 мм.',
      ['Что такое', 'МДВП БЕЛТЕРМО'],
      [
        'Плиты Белтермо - это природный материал на 94% состоящий из сосны! <br /> У нас представлены плиты всех размеров, с толщиной МДВП плиты от 20 до 200 мм. <br /> Широкая линейка утеплителей БЕЛТЕРМО позволяет выбрать материал по его назначению,опираясь на свойства, характеристики и особенности исполнения каждого его вида.',
      ],
      [
    ...
    gallery: [
      ['Примеры использования', 'МДВП БЕЛТЕРМО'],
      'МДВП Белтермо применяются в самых разных областях строительства, для самых разных целей.',

      [
        [
          'images/belplit24.ru/examples/example1',
          'Внутренняя изоляции перекрытий под стяжку бесшовных полов (ламинат, паркетная доска)',
        ],
        ['images/belplit24.ru/examples/example2', 'Внутренняя изоляция стен'],
        ['images/belplit24.ru/examples/example3', 'Утепление зданий'],
        ['images/belplit24.ru/examples/example4', 'Внешняя изоляция крыш каркасных домов'],
        ['images/belplit24.ru/examples/example5', 'Утепление внешних стен (мокрый фасад) плитами Белтермо'],
        ['images/belplit24.ru/examples/example6', 'Изоляция межэтажных перекрытий и потолка'],
      ],
    ],
  },
};
