  ...
  content: {
    head: {
      ...
      meta: [
        {
          "name": "keywords",
          "content": "купить, ламинированная, шпунтованная, древесно стружечная, плита, влагостойкие, древесные, плиты, древесная плита, древесную плиту купить в москве, плита из древесного волокна, купить, цена, москва, мо, интернет, магазин, недорого, дешево, с доставкой"
        },
        {
          "name": "description",
          "content": "Влагостойкие, ламинированные, шпунтованные древесные плиты. Едва ли какая-то стройка обходится без этих строительных материалов, а поскольку разновидностей очень много: влагостойкие, ламинированные, шпунтованные и прочие древесные плиты, стоит подробней рассмотреть все имеющиеся типы, отличительные черты и области применения."
        }
      ]
    },
    main: {
      title: 'Высокое качество по доступной цене',
      price: 'от 770 руб/шт',
    ...
    catalog: {
      title: ['Размеры и цены', 'пиломатериала'],
      text: 'У нас представлены товары разных размеров',
    },
    about: {
      title: ['Пиломатериал'],
      text: [
