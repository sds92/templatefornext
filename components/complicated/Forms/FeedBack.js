        ...
        {formStatus === 'show' && (
          <div className={`flex flex-wrap`}>
            ...
            <div className={`${classes.ff} cursor-pointer`}>
              <div
                onClick={sendForm}
                className={`cursor-pointer font-bold w-full whitespace-nowrap rounded-md shadow-md py-3.5 px-4 uppercase text-xl text-center text-zinc-100 bg-bp_red hover:bg-bp_red_2 active:scale-105`}
              >
                Отправить
              </div>
            </div>
